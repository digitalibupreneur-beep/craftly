...
apiRouter.post("/api/generate-prompt", async (req, res) => {
    try {
      const {
        jenisPlanner,
        temaPlanner,
...
`;
  ...
  apiRouter.post("/api/generate-buku-aktivitas", async (req, res) => {
    try {
      const {
        jenisHalaman,
        judulBuku,
...
`;
  ...
  apiRouter.post("/api/generate-infografis", async (req, res) => {
    try {
      const {
        judul,
        topik,
...
`;
  ...
  apiRouter.post("/api/generate-buku-cerita", async (req, res) => {
    try {
      const {
        judul,
        namaPembuat,
...
`;
  ...
  apiRouter.post("/api/generate-buku-resep", async (req, res) => {
    try {
      const {
        judul,
        namaPembuat,
...
- Make each image prompt highly descriptive.`;
  ...
  apiRouter.post("/api/generate-komik", async (req, res) => {
    try {
      const {
        judul,
        namaPembuat,
...
- Make each image prompt highly descriptive.`;
  ...
  apiRouter.post("/api/generate-buku-doa", async (req, res) => {
    try {
      const {
        judulBuku,
        namaPembuat,
...
`;
  ...
  apiRouter.post("/api/generate-amplop", async (req, res) => {
    try {
      const {
        jenisAmplop,
        customJenisAmplop,
...
The generated dieline MUST strictly follow the selected envelope size while preserving the exact engineering proportions.`;
  ...
  apiRouter.post("/api/generate-kartu-undangan", async (req, res) => {
    try {
      const {
        jenisUndangan,
        customJenisUndangan,
